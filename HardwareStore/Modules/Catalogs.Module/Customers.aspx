     ...
     <asp:MultiView ID="mtvContenedor" runat="server" ActiveViewIndex="0">
        <asp:View ID="vVista0" runat="server">
                <div class="containerCatalog">                
                    <div class="form-principal-custmers">
                       <div style="float: right">
                           <asp:Button ID="BtnClientTodos" OnClick="BtnClientTodos_Click" Text="Ver Todos" runat="server" CssClass="btnPrimary" />
                       </div>
       ...
       <%-- Vista 2 --%>
        <asp:View ID="vView1" runat="server">   
            <asp:Button OnClick="BtnAtras_Click" ID="BtnAtras" Text="Nuevo" runat="server" CssClass="btnSuccess" />
