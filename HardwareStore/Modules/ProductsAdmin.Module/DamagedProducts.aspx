<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DamagedProducts.aspx.cs" Inherits="HardwareStore.Modules.ProductsAdmin.Module.DamagedProducts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
        <ContentTemplate>
            <h1 style="color: #1F2126; text-align: center;">Productos Dañados</h1>
