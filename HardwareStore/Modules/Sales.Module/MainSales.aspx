                    ...
                    <div class="containerSales">
                        <div class="form-principal-sales">
                            ...
                            <div style="display: flex">
                                ...
                                <%--<div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Descripción</h5>
                                    <br />
                                    <br />
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtDescription" placeholder="Descripción" CssClass="form-control" />
                                </div>--%>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Bodega</h5>
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtWarehouseName" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Marca</h5>
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtBrand" placeholder="Marca" CssClass="form-control" />
                                </div>
                            </div>
                            <div style="display: flex">
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Material</h5>
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtMaterialType" CssClass="form-control" />
                                </div>

                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Dimensiones</h5>
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtDimensions" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Unidad de Medida</h5>
                                    <br />
                                    <br />
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtMeasureUnit" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Código de producto</h5>
                                    <br />
                                    <br />
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtProductCode" CssClass="form-control" />
                                </div>
                            </div>
                            <div style="display: flex">
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Existencia</h5>
                                    <asp:TextBox TextMode="Number" ReadOnly="true" runat="server" ID="txtProductStock" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Cantidad</h5>
                                    <br />
                                    <br />
                                    <asp:TextBox TextMode="Number" ReadOnly="true" runat="server" ID="txtQuantity" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Precio</h5>
                                    <asp:TextBox ReadOnly="true" runat="server" ID="txtPrice" CssClass="form-control" />
                                </div>
                                <div class="col-25">
                                    <h5 style="float: left; margin-left: 5px;">Descuento</h5>
                                    <asp:TextBox TextMode="Number" ReadOnly="true" runat="server" ID="txtDetailDiscount" CssClass="form-control" />
                                </div>
                            </div>
                ...
                <ContentTemplate>
                    ...
                    <div style="display: flex; justify-content: center;">
                        <div style="display: flex">
                            ...
                            <div title="Tasa de Cambio 35 C$" class="col-15">
